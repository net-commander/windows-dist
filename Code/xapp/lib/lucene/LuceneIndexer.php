...
class LuceneIndexer{
     ...
     */
    public function loadIndex($repositoryId, $create = true){
        require_once("Zend/Search/Lucene.php");
        $mainCacheDir = $this->indexDirectory;
        $iPath = $mainCacheDir."/indexes/index-$repositoryId";

        //error_log('indexDirectory : ' . $this->indexDirectory);

        //error_log('load indexer ' . $repositoryId);

        //error_log('index directory : ' . $iPath);
        ...
        if(is_dir($iPath)){
            ...
            if(!$create){
                ...
                throw new Exception('cant open index, auto-creation disabled');
            }
