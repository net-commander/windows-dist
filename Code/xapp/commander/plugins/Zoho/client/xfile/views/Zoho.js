define([
    ...
    function (declare, lang,TemplatedWidgetBase,CSSMixin,_StyleMixin,_InsertionMixin,utils,types,factory,MD5,cookie,json,CKEditor)
    {
        return declare("HTMLEditor.xfile.views.HTMLEditor", [TemplatedWidgetBase,CSSMixin,_StyleMixin,_InsertionMixin],
            {
                config:null,
                ctx:null,
                ...
                createWidgets:function(){
                    ...
                    factory.createButton(this.layoutTop.containerNode, "el-icon-caret-left", "toolbarButton", "", "", this.onLeft, this);
                    factory.createToggleButton(this.layoutTop.containerNode, "el-icon-link", "toolbarButton", "", "", this.onSelect, this,true);
                    factory.createButton(this.layoutTop.containerNode, "el-icon-caret-right", "toolbarButton", "", "", this.onRight, this);
                },
                createPanels:function(config){

                    this.leftPanel = this.ctx.getScriptManager().openFile(this.item,this.layoutLeft);
                    var editor = this._createEditor(this.item.path);
