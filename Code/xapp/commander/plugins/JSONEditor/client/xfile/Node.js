define([
    ...
    './ContextMenu',
    './appendNodeFactory'
], function (declare,util,ContextMenu,appendNodeFactory) {


    //return declare("xide.json.JSONEditor", null,{});
            ...
            for (var childField in value) {
                ...
                if (value.hasOwnProperty(childField)) {
                    ...
                    if (childValue !== undefined && !(childValue instanceof Function)) {
                        ...
                        var hiddenField = this.editor.hiddenFields[childField];
                        if(
                            hiddenField!==true &&
                            this.editor.onAddNode({
                                parent:this,
                                field: childField,
                                value: childValue
                            })!==false)
     ...
     */
    Node.prototype.collapse = function(recurse,silent) {
        if (!this.childs) {
            return;
        }
