...
JSONEditor.Node.prototype.expand = function(recurse) {
    ...
    this.expanded = true;
    if (this.dom.expand) {
        this.dom.expand.className = 'jsoneditor-expanded fa-caret-down';
    }
...
JSONEditor.Node.prototype.collapse = function(recurse) {
    ...
    if (this.dom.expand) {
        this.dom.expand.className = 'jsoneditor-collapsed fa-caret-right';
    }
    this.expanded = false;
};
...
JSONEditor.Node.prototype._createDomExpandButton = function () {
    ...
    if (expandable) {
        expand.className = this.expanded ? 'jsoneditor-expanded fa-caret-down' : 'jsoneditor-collapsed fa-caret-right';
        expand.title =
...
JSONEditor.prototype._createFrame = function () {
    ...
    expandAll.className = 'jsoneditor-menu jsoneditor-expand-all fa-expand ui-button dijitButton actionToolbarButtonElusive';
    ...
    collapseAll.className = 'jsoneditor-menu jsoneditor-collapse-all fa-compress ui-button dijitButton actionToolbarButtonElusive';
...
JSONFormatter = function (container, options, json) {
    ...
    this.frame = document.createElement('div');
    this.frame.className = "jsoneditor-frame ui-state-default";
    this.frame.onclick = function (event) {
