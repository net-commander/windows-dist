...
exports.Audio_Output = Struct({
    name: ref.types.CString,
    description: ref.types.CString
});

exports.Audio_OutputPtr = ref.refType(exports.Audio_Output);
exports.Audio_Output.defineProperty('next', exports.Audio_OutputPtr);

exports.Audio_Output_Device = Struct({
    psz_device: ref.types.CString,
    psz_description: ref.types.CString
});

exports.Audio_Output_Device_Ptr = ref.refType(exports.Audio_Output_Device);
exports.Audio_Output_Device.defineProperty('p_next', exports.Audio_Output_Device_Ptr);
