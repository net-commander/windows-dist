...
declare module '@xblox/core/shim/support/global' {
	 const globalObject: any;
	export default globalObject;

}
declare module '@xblox/core/shim/support/has' {
	import has from '@xblox/core/has';
	export default has;
	export * from '@xblox/core/has';

}
declare module '@xblox/core/shim/support/util' {
	/**
...
declare module '@xblox/core/shim/Symbol' {
	 global  {
...
declare module '@xblox/core/shim/object' {
	/**
	 ...
	 * @param o Object that contains the properties and methods.
	 */
	export const entries: (o: any) => any[];
	export const getOwnPropertyDescriptor: (o: any, property: string | symbol) => PropertyDescriptor | undefined;
	export const getOwnPropertyDescriptors: (o: any) => any;
